// Demo data for display purposes when Firebase is not configured
export const demoListings = [
  {
    id: "1",
    userId: 1,
    title: "Cozy 2BR Near Campus - Spring Sublease",
    description: "Beautiful 2-bedroom apartment just 0.5 miles from Notre Dame campus. Fully furnished with modern amenities. Perfect for students looking for a comfortable living space during spring semester. The apartment features a spacious living room, full kitchen, and in-unit laundry. Walking distance to campus and local restaurants.",
    price: "1200",
    bedrooms: 2,
    bathrooms: 1.5,
  ...
  },
  {
    ...
    description: "Stylish studio apartment in downtown South Bend. Recently renovated with high-end finishes. Great for graduate students or those who prefer city living. Features include exposed brick walls, large windows with great natural light, and a modern kitchen with stainless steel appliances.",
    price: "950",
    bedrooms: 1,
    bathrooms: 1,
  ...
  },
  {
    ...
    description: "Large 3-bedroom house perfect for a group of students. Features include a big backyard for gatherings, full basement, and plenty of parking. Located on Eddy Street with easy access to campus and the Commons. House comes with all major appliances and has been well-maintained.",
    price: "1800",
    bedrooms: 3,
    bathrooms: 2,
  ...
  },
  {
    ...
    description: "Premium 1-bedroom apartment in the heart of University Commons. Walking distance to campus with access to all Commons amenities including restaurants, shops, and entertainment. Features granite countertops, hardwood floors, and floor-to-ceiling windows.",
    price: "1400",
    bedrooms: 1,
    bathrooms: 1,
  ...
  },
  {
    ...
    description: "Budget-friendly 2-bedroom apartment ideal for students looking to share costs. Clean, safe, and well-maintained building with on-site management. Each bedroom is a good size and the common areas are comfortable for studying and relaxing.",
    price: "800",
    bedrooms: 2,
    bathrooms: 1,
  ...
  },
  {
    ...
    description: "Lovely duplex unit in a quiet residential neighborhood. Features include a private balcony, updated kitchen, and peaceful setting perfect for studying. Great for students who prefer a quieter environment while still being close to campus.",
    price: "1100",
    bedrooms: 2,
    bathrooms: 1,
